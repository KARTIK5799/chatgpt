...
V:[{I:"path",W:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.J=a;this.Sa("click",this.onClick,this);this.updateValue("title",g.LU(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});g.wb(this,g.FU(b.Ec(),this.element))},gpb=function(a){g.U.call(this,{I:"div",
...
g.k.kO=function(){this.tooltip=new g.TX(this.player,this);g.L(this,this.tooltip);g.rU(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.fd=new g.eW(this.player);g.L(this,this.fd);this.vk=new g.U({I:"div",S:"ytp-miniplayer-scrim"});g.L(this,this.vk);this.vk.Fa(this.element);this.T(this.vk.element,"click",this.kJ);var a=new g.U({I:"button",Ma:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Close"},V:[g.sG()]});g.L(this,a);a.Fa(this.vk.element);this.T(a.element,"click",this.Gp);
...
Ma:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Close"},V:[g.sG()]});g.L(this,a);a.Fa(this.UI.element);this.T(a.element,"click",this.Gp);a=new g.U({I:"button",Ma:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"Close"},V:[g.jva()]});g.L(this,a);a.Fa(this.UI.element);this.T(a.element,"click",this.Y8);this.T(this.player,"presentingplayerstatechange",this.Wd);this.T(this.player,"appresize",this.Kb);this.T(this.player,"fullscreentoggled",this.Kb);this.Kb()};
